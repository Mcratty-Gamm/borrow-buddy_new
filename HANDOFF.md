...
| T8.2 – T8.6 ตรวจรับในเบราว์เซอร์ | **กำลังทำ** | T8.2 ผ่าน, T8.6 ส่วนโค้ดผ่าน (ไม่มีฟีเจอร์นอกขอบเขต, ศัพท์ตรง CONTEXT.md, ไม่มี secret key) |

งานเวอร์ชัน 2 commit แล้ว (`6fd18c8` … `0057878`)

## สิ่งที่ต้องทำต่อ
1. ตรวจรับ T8.2 – T8.6 ในเบราว์เซอร์ (มีบัญชีเจ้าของ + บัญชีทดสอบที่สองแล้ว) ผู้ใช้กรอกอีเมล/รหัสผ่านเอง ห้ามขอรหัสผ่านในแชต
